...
function multi_vertices(gl,vertices_count) {

}


function Multi_object_draw(gl,vertexShaderSource,fragmentShaderSource){
    let vertices_count= 10000;
    let currentx = -0.5;
    let currenty = -0.5;
    let currentz = 0;
    let vertexArray = multi_vertices(gl,vertices_count);
